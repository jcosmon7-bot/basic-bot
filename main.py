...
# --- CONFIGURATION ---
# 10 Pairs (Mix of Major Crypto & Forex)
SYMBOLS = [
    "BTC-USD", "ETH-USD", "SOL-USD", "XRP-USD", "BNB-USD",  # Crypto
    "EURUSD=X", "GBPUSD=X", "USDJPY=X", "AUDUSD=X", "GC=F"  # Forex & Gold
]
TIMEFRAME = "1d"    
...
class ICT_Blueprint_Bot:
    ...
    def calculate_indicators(self):
        # ERROR FIX: Start loop at 2 to avoid negative index
